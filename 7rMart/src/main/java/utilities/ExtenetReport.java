...
public class ExtenetReport implements ITestListener {
	...
	public void configureReport() {
		...
		reports.setSystemInfo("Project", "7rMart");
		reports.setSystemInfo("PC Name", "Dhiviya's pc");
		reports.setSystemInfo("OS", "Windows 11");
		reports.setSystemInfo("Test Done By", "Dhiviya");
		sparkReporter.config().setDocumentTitle("Grocery apllication Report ");
	...
	public void onTestSuccess(ITestResult result) {
		test = reports.createTest(result.getName());//it gets testcase name
