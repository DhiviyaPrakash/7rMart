...
public class ScreenShotCapture {
	...
	TakesScreenshot scrShot = (TakesScreenshot) driver;// takes screen shot
	...
	if (!f1.exists()) {//if folder exists this line will not work
		f1.mkdirs();
	}
	...
	File finalDestination = new File(
			System.getProperty("user.dir") + "\\OutputScreenshots\\" + name + "_" + timeStamp + ".png");//creating new file with name & timeStamp
	FileHandler.copy(screenShot, finalDestination);//copying screenshot from temporary path to final destination
